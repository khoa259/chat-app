  ...
  return (
    <div>
      <div className="heading mb-12">
        <h1 className="text-2xl font-semibold capitalize text-gray-500">{t("Welcome back")} !</h1>
      </div>
          ...
          <div className="content z-10">
            ...
            <div className="mt-20 text-center">
              <p>
                ...
                <Link className="font-medium text-[var(--cl-green)] underline" to={urlRoute.SIGNUP}>
                  {t("Signup")}
                </Link>
              </p>
            </div>
